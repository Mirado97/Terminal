"""Binance адаптер: WS bookTicker (spot)."""
...
class BinanceAdapter(BaseExchange):
    ...
    def set_latency_tracker(self, tracker: Any, name: str = "binance") -> None:
